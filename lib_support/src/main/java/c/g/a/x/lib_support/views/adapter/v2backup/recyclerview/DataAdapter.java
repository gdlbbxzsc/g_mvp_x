...
//import c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder;
...
//
//public class DataAdapter extends RecyclerView.Adapter<c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder.RecyclerViewViewHolder> {
//
...
//
//    @Override
//    public c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder.RecyclerViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//        c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder holder = null;
//        try {
//            holder = (c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder) getItemViewTypeClass(viewType).newInstance();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
...
//
//    @Override
//    public void onBindViewHolder(c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder.RecyclerViewViewHolder holder, int position) {
//
...
//
//    @Override
//    public void onBindViewHolder(c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder.RecyclerViewViewHolder holder, int position, List<Object> payloads) {
...
//    }
//
//    public void onGetView(c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder holder) {
//    }
//
//    public void onShowView(c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder holder, List<Object> payloads) {
//    }
//
...
//
//
//    public interface OnItemClickListener<T extends c.g.a.x.lib_support.views.adapter.v2.recyclerview.ViewHolder> {
