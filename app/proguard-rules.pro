...
-keep class * extends c.g.a.x.lib_db.base.BaseDaoModel{ *; }
-keep class * extends c.g.a.x.lib_http.base.BaseRequest{ *; }
...
-keep class c.g.a.x.lib_support.views.**  {*;}
...
# aaplogic
-keep public class * extends c.g.a.x.applogic_api.base.BaseAppLogic{ *; }
-keep public class * implements c.g.a.x.applogic_api.base.IAppLogicFullNamesLoader{ *; }

-keep public class c.g.a.x.applogic_compiler.AppLogicProcessor{ *; }
